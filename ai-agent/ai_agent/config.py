...
class Settings(BaseSettings):
    ...
    log_file: Optional[str] = Field(default="/mnt/ssd-logs/ai-agent/logs/actions.log", env="LOG_FILE")
    ...
    # Reports
    reports_dir: str = Field(default="/mnt/ssd-logs/ai-agent/reports", env="REPORTS_DIR")
